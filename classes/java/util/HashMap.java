...
public class HashMap<K,V> extends AbstractMap<K,V>
    ...
    /**
     * 默认的初始容量为16，容量必须为2的倍数（即每次以2的倍数扩容）
     */
    ...
    /**
     * 链表升级为红黑树的阈值（1.8开始为了提升hash冲突下查询的效率引入了红黑树）
     */
    ...
    /**
     * Node表示键值对，1.8以前的版本是Entry，1.8因为引入了红黑树，因此采用了Node
     */
    ...
    /**
     * 求出大于等于cap的最小2的幂次，例如cap等于31时，为32，cap等于33时，则为64，cap等于32时，也为32
     */
    ...
    /**
     * 触发扩容的阈值 table被初始化后threshold = capacity * loadfactory，
     */
    int threshold;
